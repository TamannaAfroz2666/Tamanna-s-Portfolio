      ...
      <div className="text-center">
        <div className="relative mx-auto h-24 w-24">
          ...
          <span className="absolute bottom-1 right-1 inline-flex h-4 w-4 items-center justify-center">
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#1b5133] " />
            <span className="relative inline-flex h-2.5 w-2.5 rounded-full bg-[#1bc766] ring-2 ring-[#0b0b0f]" />
          </span>
        </div>
        <div>
